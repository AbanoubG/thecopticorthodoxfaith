package org.copticchurch.library.discoverorthodoxy.activities.usersettings.slidertimeperiod;
...
public class TimePeriodSlider extends LinearLayout implements DiscreteSeekBar.OnProgressChangeListener {
    ...
    private void readAttributes(AttributeSet attrs) {
        ...
        TypedArray attrArray = getContext().obtainStyledAttributes(attrs, org.copticchurch.library.discoverorthodoxy.R.styleable.TimePeriodSlider, 0, 0);
        try {
            mDateType = attrArray.getInteger(org.copticchurch.library.discoverorthodoxy.R.styleable.TimePeriodSlider_dateComponent, DateComponent.WEEKS);
    ...
    public void init() {
        LayoutInflater.from(getContext()).inflate(org.copticchurch.library.discoverorthodoxy.R.layout.control_time_period_slider, this, true);
        this.setOrientation(VERTICAL);

        mSeekBar = (DiscreteSeekBar) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.seekBar);
        mTypeText = (TextView) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.typeText);
    ...
    public void setDateType(int dateType) {
        ...
        mCurrentValue = (TextView) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.currentValue);
