...
public class MultipleChoiceFragment extends AnswerFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //inflate the view
        View view = inflater.inflate(org.copticchurch.library.discoverorthodoxy.R.layout.fragment_challenge_multiple_choice, container, false);

        final int SPANS = 2;
        mRecyclerView = (RecyclerView) view.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.buttonsRecyclerView);
