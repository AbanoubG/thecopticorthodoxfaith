    ...
    public List<Long> fillChart(PieChart chart, StatisticType type) {
        ...
        switch (type) {
            case TYPE_DUE:
                ...
                chart.setCenterText(mApplication.getString(org.copticchurch.library.discoverorthodoxy.R.string.due_chart_center_text));
                break;
            case TYPE_STAGE:
                data = mDataLogic.findStageData();
                chart.setCenterText(mApplication.getString(org.copticchurch.library.discoverorthodoxy.R.string.stage_chart_center_text));
                break;
            default:
