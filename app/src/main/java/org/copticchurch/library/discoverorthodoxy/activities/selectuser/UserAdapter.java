...
import org.copticchurch.library.discoverorthodoxy.activities.createuser.Avatars;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserViewHolder> {
    ...
    public UserViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View customView = myInflater.inflate(org.copticchurch.library.discoverorthodoxy.R.layout.list_item_user, parent, false);
    ...
    public class UserViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener, View.OnClickListener,
        ...
        public UserViewHolder(View itemView, UserAdapter adapter) {
            ...
            mUserText = (TextView) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.userItemText);
            mUserImage = (ImageView) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.userItemImage);
            mAdapter = adapter;
        }
        ...
        public void bindUser(final User user) {
            ...
            if (user.getId().equals(mAdapter.getUserManager().getCurrentUser().getId())) {
                mUserText.setTextColor(ContextCompat.getColor(itemView.getContext(), org.copticchurch.library.discoverorthodoxy.R.color.colorAccent));
            } else {
