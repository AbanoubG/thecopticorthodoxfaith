...
import org.copticchurch.library.discoverorthodoxy.database.ChallengeStage;
...
public class ChallengeActivity extends BrainPhaserActivity implements AnswerFragment.AnswerListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Content View
        setContentView(org.copticchurch.library.discoverorthodoxy.R.layout.activity_challenge);
        ...
        //get the views
        mFloatingActionButton = (FloatingActionButton) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.btnNextChallenge);
        mQuestionText = (TextView) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.challengeQuestion);
        mProgress = (ProgressBar) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.progress_bar);
        mCategoryText = (TextView) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.challenge_category);
        mTypeText = (TextView) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.challenge_type);
        mClassText = (TextView) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.challenge_class);
        ...
        if (mLoadNextChallengeOnFabClick) {
            mFloatingActionButton.setImageResource(org.copticchurch.library.discoverorthodoxy.R.drawable.ic_navigate_next_white_24dp);
        } else {
            mFloatingActionButton.setImageResource(org.copticchurch.library.discoverorthodoxy.R.drawable.ic_check_white_24dp);
        }
    ...
    private void loadChallenge() {
        ...
        transaction.replace(org.copticchurch.library.discoverorthodoxy.R.id.challenge_fragment, fragment, "" + mCurrentChallenge.getChallengeType());
    ...
    private void initializeMetaData() {
        ...
        mClassText.setText(getString(org.copticchurch.library.discoverorthodoxy.R.string.stage_num, stage));
    ...
    private void floatingActionButtonClicked() {
        ...
        AnswerFragment currentFragment = (AnswerFragment) getSupportFragmentManager().findFragmentById(org.copticchurch.library.discoverorthodoxy.R.id.challenge_fragment);
    ...
    private void loadFinishScreen() {
        ...
        NestedScrollView contentLayout = (NestedScrollView) findViewById(org.copticchurch.library.discoverorthodoxy.R.id.challenge_rootcontainer);
        if (contentLayout != null) {
            contentLayout.removeAllViews();
            View view = getLayoutInflater().inflate(org.copticchurch.library.discoverorthodoxy.R.layout.fragment_finish_challenge, contentLayout, false);
