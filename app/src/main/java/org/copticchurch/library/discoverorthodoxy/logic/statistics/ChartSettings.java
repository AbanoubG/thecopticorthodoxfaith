package org.copticchurch.library.discoverorthodoxy.logic.statistics;
...
public class ChartSettings {
    ...
    public ChartSettings(BrainPhaserApplication application) {
        ...
        mColorsetStage[0] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorStage1);
        mColorsetStage[1] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorStage2);
        mColorsetStage[2] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorStage3);
        mColorsetStage[3] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorStage4);
        mColorsetStage[4] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorStage5);
        mColorsetStage[5] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorStage6);

        mColorsetPlayed[0] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorPlayed1);
        mColorsetPlayed[1] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorPlayed2);
        mColorsetPlayed[2] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorPlayed3);

        mColorsetDue[0] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorDue);
        mColorsetDue[1] = ContextCompat.getColor(applicationContext, org.copticchurch.library.discoverorthodoxy.R.color.colorNotDue);
    }
    ...
    public void applyNoDataSettings(Chart chart) {
        chart.setNoDataText(mApplication.getString(org.copticchurch.library.discoverorthodoxy.R.string.chart_no_data_text));
