...
import org.copticchurch.library.discoverorthodoxy.activities.usersettings.slidertimeperiod.DateComponent;
...
import org.copticchurch.library.discoverorthodoxy.activities.usersettings.slidertimeperiod.TimePeriodSlider;
...
class SettingsViewHolder extends RecyclerView.ViewHolder implements TimePeriodSlider.OnChangeListener {
    ...
    public SettingsViewHolder(View itemView,
        ...
        mTitle = (TextView) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.stageTitle);
        mTime = (TextView) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.stageTime);
        mButton = (Button) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.saveButton);
        mErrorLayout = (CollapsingLinearLayout) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.errorLayout);
        mErrorText = (TextView) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.errorText);
        mConfigArea = (CollapsingLinearLayout) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.config_area);
        mExpandButton = (ImageButton) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.expand_settings_button);

        // Intialize the formater
        Resources res = itemView.getResources();
        mFormatter = new PeriodFormatterBuilder()
            .appendWeeks().appendSuffix(" ").appendSuffix(res.getString(org.copticchurch.library.discoverorthodoxy.R.string.formatter_week), res.getString(org.copticchurch.library.discoverorthodoxy.R.string.formatter_weeks))
            .appendSeparator(", ")
            .appendDays().appendSuffix(" ").appendSuffix(res.getString(org.copticchurch.library.discoverorthodoxy.R.string.formatter_day), res.getString(org.copticchurch.library.discoverorthodoxy.R.string.formatter_days))
            .appendSeparator(", ")
            .appendHours().appendSuffix(" ").appendSuffix(res.getString(org.copticchurch.library.discoverorthodoxy.R.string.formatter_hour), res.getString(org.copticchurch.library.discoverorthodoxy.R.string.formatter_hours))
            .appendSeparator(", ")
            .appendMinutes().appendSuffix(" ").appendSuffix(res.getString(org.copticchurch.library.discoverorthodoxy.R.string.formatter_minute), res.getString(org.copticchurch.library.discoverorthodoxy.R.string.formatter_minutes))
            .printZeroNever()
            .toFormatter();
        ...
        LinearLayout header = (LinearLayout) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.header);
        ...
        Button cancelButton = (Button) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.cancelButton);
    ...
    public void bindStage(Date currentDate, int stage) {
        mStage = stage;
        mTitle.setText(itemView.getResources().getString(org.copticchurch.library.discoverorthodoxy.R.string.setting_stage, stage));
