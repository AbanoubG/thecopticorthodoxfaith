...
public class Avatars {
    ...
    private static final Integer[] AVATARS = {
            R.drawable.christ2, R.drawable.christ3,
            R.drawable.chrsit4, R.drawable.christ,
            R.drawable.cross3, R.drawable.cross1,
            R.drawable.cross, R.drawable.theotokos,
            R.drawable.moses, R.drawable.mark,
            R.drawable.john, R.drawable.geroge
    };
    ...
    public static Integer getDefaultAvatarResourceId() {
        return org.copticchurch.library.discoverorthodoxy.R.drawable.christ3;
    }
}
