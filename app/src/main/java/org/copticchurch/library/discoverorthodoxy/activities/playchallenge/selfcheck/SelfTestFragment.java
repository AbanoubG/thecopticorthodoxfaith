package org.copticchurch.library.discoverorthodoxy.activities.playchallenge.selfcheck;
...
public class SelfTestFragment extends AnswerFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mCheckingAnswer) {
            ...
            View view = inflater.inflate(org.copticchurch.library.discoverorthodoxy.R.layout.fragment_challenge_self_test, container, false);

            Button btnRight = (Button) view.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.answerRight);
            Button btnWrong = (Button) view.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.answerWrong);
            ...
            return inflater.inflate(org.copticchurch.library.discoverorthodoxy.R.layout.fragment_challenge_self_test_null, container, false);
        }
    }
    ...
    public void onStart() {
        ...
        if (mCheckingAnswer) {
            ...
            populateRecyclerViewWithCorrectAnswers(org.copticchurch.library.discoverorthodoxy.R.id.answerListSelfCheck, null);
        }
    }
