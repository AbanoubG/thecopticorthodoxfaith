...
public class AvatarPickerDialogFragment extends DialogFragment implements AdapterView.OnItemClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(org.copticchurch.library.discoverorthodoxy.R.layout.avatar_picker, null);
        builder.setView(view);

        GridView gridView = (GridView) view.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.avatarGrid);
        gridView.setAdapter(new AvatarImageAdapter(getContext()));
        gridView.setOnItemClickListener(this);

        final AvatarPickerDialogFragment self = this;
        builder.setMessage(org.copticchurch.library.discoverorthodoxy.R.string.dialog_pick_avatar)
                .setPositiveButton(org.copticchurch.library.discoverorthodoxy.R.string.select, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
                        mListener.onAvatarSelected(self, mSelectedAvatarResourceEntryName);
                    }
                })
                .setNegativeButton(org.copticchurch.library.discoverorthodoxy.R.string.cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        int accentColor = ContextCompat.getColor(getContext(), org.copticchurch.library.discoverorthodoxy.R.color.colorAccent);
