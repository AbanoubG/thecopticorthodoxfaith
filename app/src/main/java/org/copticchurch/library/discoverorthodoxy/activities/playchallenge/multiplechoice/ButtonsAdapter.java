package org.copticchurch.library.discoverorthodoxy.activities.playchallenge.multiplechoice;
...
public class ButtonsAdapter extends RecyclerView.Adapter<ButtonsAdapter.ButtonViewHolder> {
    ...
    public ButtonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(org.copticchurch.library.discoverorthodoxy.R.layout.multiplechoice_button, parent, false);

        // Clone drawable to allow modifications
        ToggleButton button = (ToggleButton) v.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.toggleButton);
    ...
    public class ButtonViewHolder extends RecyclerView.ViewHolder {
        ...
        public ButtonViewHolder(View itemView) {
            super(itemView);
            mToggleButton = (ToggleButton) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.toggleButton);
            mSelectionCorrectMarker = (ImageView) itemView.findViewById(org.copticchurch.library.discoverorthodoxy.R.id.selectionCorrectIndicator);
        }
        ...
        public void adjustBackground(boolean correct) {
            ...
            if (correct) {
                ...
                ((GradientDrawable) drawable.getCurrent()).setColor(ContextCompat.getColor(itemView.getContext(), org.copticchurch.library.discoverorthodoxy.R.color.buttonBackgroundRight));
            } else {
                StateListDrawable drawable = (StateListDrawable) mToggleButton.getBackground();
                ((GradientDrawable) drawable.getCurrent()).setColor(ContextCompat.getColor(itemView.getContext(), org.copticchurch.library.discoverorthodoxy.R.color.buttonBackground));
            }
        }
        ...
        public boolean performAnswerCheck() {
            ...
            if (mToggleButton.isChecked()) {
                ...
                if (answerCorrect) {
                    mSelectionCorrectMarker.setImageResource(org.copticchurch.library.discoverorthodoxy.R.drawable.ic_check);
                } else {
                    mSelectionCorrectMarker.setImageResource(org.copticchurch.library.discoverorthodoxy.R.drawable.ic_cross);
                }
            } else {
